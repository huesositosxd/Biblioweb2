"""
Django settings for BiblioParque project.
...
ROOT_URLCONF = 'BiblioParque.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'Aplicaciones' / 'Visitas' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'BiblioParque.wsgi.application'
